...
const analysis = computed(() => {
  return workSpaceStore.result?.data.ai_analysis
})
...
<template>
  <div v-if="analysis" class="flex flex-col gap-5">
    ...
    <button
      ...
      class="w-full h-10 rounded-lg border border-white/5 bg-white/2 px-2.5 py-2 text-neutral-400 hover:bg-brand-500/10 hover:border-brand-500/20 hover:text-brand-300 flex items-center justify-center gap-2 transition-all"
    >
